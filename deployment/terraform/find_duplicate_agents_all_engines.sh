...
ENGINES=(
  "enterprise-search-17489269_1748926990192"
  "ge-app-dev_1769811308679"
  "ge-app-dw-test1_1764005317392"
)

for ENGINE in "${ENGINES[@]}"; do
  echo "Checking Engine: $ENGINE"
  URL="https://discoveryengine.googleapis.com/v1alpha/projects/496235138247/locations/global/collections/default_collection/engines/${ENGINE}/assistants/default_assistant/agents"
  NEXT_PAGE_TOKEN=""
